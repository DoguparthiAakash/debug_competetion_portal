...
/* ══════════════════════════════════════════════════════════
   ...
   Update student details (status, violations, profile).
   ══════════════════════════════════════════════════════════ */
router.put('/students/:id', authMiddleware, async (req, res) => {
  try {
    const studentId = req.params.id;
    const updates = req.body; // { isDisqualified, contestStatus, violationAttempts, ... }

    // Prevent updating specific immutable fields if necessary (like scores manually without recalc?)
